...
using Fluentis.FluentisErp.Mvvm.SD.SalesDeliveryNotes.ViewModels;
...
/*END EDIT ZONE*/
namespace DEMO.FluentisErp.Mvvm.SD.SalesDeliveryNotes.ViewModels
{
    public partial class CustomSalesDeliveryNoteFilterViewModel : Fluentis.FluentisErp.Mvvm.SD.SalesDeliveryNotes.ViewModels.SalesDeliveryNoteFilterViewModel
    {
        ...
        /*END EDIT ZONE*/
        public CustomSalesDeliveryNoteFilterViewModel()
        {

            #region Widget properties initialization

            #endregion
            // START WIZARD CODE [CustomSalesDeliveryNoteFilterViewModel]
            // END WIZARD CODE
            /*START EDIT ZONE [CustomSalesDeliveryNoteFilterViewModel]*/
            int a = 0;
            /*END EDIT ZONE*/
        }
